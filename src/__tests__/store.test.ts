...
describe('Store', () => {
    ...
    describe('Cart Operations', () => {
        it('should save and retrieve a cart', () => {
            const cart: Cart = { id: 'cart1', items: [{ productId: 'p1', quantity: 1, price: 100 }], userId: '1234' };
            store.saveCart(cart);
            const retrievedCart = store.getCart('cart1');
    ...
    describe('Order Operations', () => {
        ...
        it('should generate a discount code on the Nth order', () => {
            ...
            const { order: createdOrder, generatedCode } = store.createOrder(nthOrder);
